...
\medbreak
\item Released Pictura, a GPU-accelerated multi-agent driving simulator that
renders each agent’s egocentric view (ECCV 2026 workshop paper)
\medbreak
...
\begin{itemize}
    ...
    \medbreak
    \item I enjoy (trail) running, biking (\href{https://github.com/elias-ramzi/ClaudeCyclingMCP/}{\faGithub\enspace ClaudeCyclingMCP}) and back-country skiing.
\end{itemize}
