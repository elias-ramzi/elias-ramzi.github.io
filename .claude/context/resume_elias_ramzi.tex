...
\begin{tabular}{ c c c c }
 \faEnvelope[regular]\enspace \href{mailto:elias.ramzi@gmail.com}{elias.ramzi@gmail.com} & \faMobile\enspace+33\enspace6 28 25 40 88 &    \faGithub\enspace \href{https://elias-ramzi.github.io/}{elias-ramzi} & \faGraduationCap\enspace \href{https://scholar.google.com/citations?user=mbfTD_UAAAAJ}{Google Scholar} \\
\end{tabular}
\end{center}
...
{\customcvproject{Engineering diploma, CentraleSupélec (France)}{2016-2020}
  {Courses in signal processing, machine learning, statistical models, data science.}
}
...
\skillgroup{Open source projects}{
   ...
   \item Pictura simulator (ECCVw'26): \href{https://github.com/valeoai/Pictura/}{\faGithub\enspace Pictura}
   \item Scaling laws for driving video diffusion models (ECCVw'26): \href{https://github.com/valeoai/VATIX/}{\faGithub\enspace VATIX}
...
Victor Besnier, Anh-Quan Cao, \textbf{Elias Ramzi}, Spyros Gidaris, Tuan-Hung Vu, Andrei Bursuc, {\'E}loi Zablocki, Matthieu Cord. \href{https://openreview.net/forum?id=V33on0TguP}{"How Far Can 5,500 Hours of Driving Take You? A Scaling Law Analysis of Video Diffusion Models."} \textit{ECCVw}, 2026.
